...
import { sendLeadNotification, sendApplication } from "../../../utils/firebase";
...
const ApplicationMsg = ({ groupData, applicationData, appliedData }) => {
  ...
  const handleSubmit = () => {
    ...
    sendApplication(groupData.groupID, data, userData.uid).then(() => {
      sendLeadNotification(groupData.groupID, groupData.creatorID);
